...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Documentación de la protectora de Animales")
				.description("Informacion completa sobre la API REST para consumo de clientes de todo tipo")
				.termsOfServiceUrl("En contrucción")
				.contact(new Contact("Laura Barrero Sánchez", "laura.barrero@smarting.es", null)).version("1.0")
				.build();
	}
}
